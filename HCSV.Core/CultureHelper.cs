...
namespace HCSV.Core
{
    public class CultureHelper
    {
        ...
        public static double FormatGrade(string strInput, string strLanguage)
        {
            string strOutput = string.Empty;
            double s = 0;
            if (strLanguage.ToLower() == "vi-vn")
            {
            ...
            double.TryParse(strOutput.ToString(), out s);
            return s;
        }
        public static string ConvertToNumberInEnglish(double input)
        {
