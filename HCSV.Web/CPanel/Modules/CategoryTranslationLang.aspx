<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="CategoryTranslationLang.aspx.cs" ValidateRequest="false" Inherits="CPanel.Modules.CategoryTranslationLang" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="main_contain_css main_contain_css_1 main_2">
        ...
        <asp:TextBox ID="txtCategoryID2" CssClass="invisible_css" runat="server" Text=""></asp:TextBox>
    </div>
